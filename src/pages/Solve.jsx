...
import { Home, Trophy, Bookmark, GraduationCap, ChevronRight, ChevronLeft, ChevronDown, Grid3X3 } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#F5F8FF] text-slate-900">
      ...
      <div className="flex">
        ...
        {/* Vertical pale background divider for small screens */}
        <div className="lg:hidden fixed top-0 left-0 right-0 z-10 bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/50 border-b border-slate-200">
